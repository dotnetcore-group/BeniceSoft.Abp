...
/// <summary>
/// SystemTextJson 序列化器测试
/// </summary>
public class SystemTextJsonCacheValueSerializerTests
{
    private readonly SystemTextJsonCacheValueSerializer _serializer = new();

    [Fact]
    public void Name_ShouldBe_SystemTextJson()
    {
        _serializer.Name.ShouldBe("SystemTextJson");
    }
    ...
    {
        var original = new TestDto { Id = 1, Name = "Test" };
        var bytes = _serializer.Serialize(original);
        var json = System.Text.Encoding.UTF8.GetString(bytes);
        
        // 验证使用了 camelCase 命名策略
